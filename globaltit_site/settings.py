"""
Django settings for globaltit_site project.
"""
...
# Application definition definition de l'application 
INSTALLED_APPS = [
...
ROOT_URLCONF = 'globaltit_site.urls'
...
WSGI_APPLICATION = 'globaltit_site.wsgi.application'
...
CONTACT_EMAIL = config('CONTACT_EMAIL', default='info@global-it.ca')
